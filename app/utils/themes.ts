...
import type { PresentationThemeProperties } from '~/types/presentation-theme'
...
export function setPresentationThemeVariables(theme: PresentationThemeProperties, isDark: boolean) {
