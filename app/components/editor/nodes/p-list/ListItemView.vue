...
<template>
  <NodeViewWrapper :id="node.attrs.id" class="p-list-item group/bullet-item relative flex items-start p-4 hover:outline-1 outline-blue-400" :data-index="index" :data-selected="selected">
    <div
      :class="cn(
